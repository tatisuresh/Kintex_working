...
//localparam 	integer				IDELAY_TAP_REG_D = nearest_32multiple(8*(LVDS_LINK_WIDTH+1))/32;
...
// localparam                  REGISTERS_NBR  = (DATA_WIDTH)/32 + 2*IDELAY_TAP_REG + CLOCK_PTRN_REG + 1;
...
// reg  [REGISTERS_NBR-1:0]		reg_rstvalue[31:0];
// wire [REGISTERS_NBR-1:0]		reg_rd_value[31:0];
// reg  [REGISTERS_NBR-1:0]		reg_wr_value[31:0];
