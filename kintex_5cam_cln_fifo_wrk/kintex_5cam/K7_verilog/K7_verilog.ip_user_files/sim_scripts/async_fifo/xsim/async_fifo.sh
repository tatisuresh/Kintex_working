...
#
# Script generated by Vivado on Sat Mar 16 12:55:02 +0530 2024
...
#
# Usage        : async_fifo.sh
#                async_fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                async_fifo.sh [-reset_run]
#                async_fifo.sh [-reset_log]
#                async_fifo.sh [-help]
#
...
# script info
echo -e "async_fifo.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./async_fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot async_fifo xil_defaultlib.async_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim async_fifo -key {Behavioral:sim_1:Functional:async_fifo} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb async_fifo.wdb xsim.dir libdpi.so)
...
Usage: async_fifo.sh [-step]\n\
Usage: async_fifo.sh [-lib_map_path]\n\
Usage: async_fifo.sh [-reset_run]\n\
Usage: async_fifo.sh [-reset_log]\n\
Usage: async_fifo.sh [-keep_index]\n\
