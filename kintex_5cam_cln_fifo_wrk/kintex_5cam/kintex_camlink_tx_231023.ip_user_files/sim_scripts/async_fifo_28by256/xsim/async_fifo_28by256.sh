...
#
# Script generated by Vivado on Wed Mar 13 19:26:26 +0530 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : async_fifo_28by256.sh
...
#
# Usage        : async_fifo_28by256.sh
#                async_fifo_28by256.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                async_fifo_28by256.sh [-reset_run]
#                async_fifo_28by256.sh [-reset_log]
#                async_fifo_28by256.sh [-help]
#
...
# script info
echo -e "async_fifo_28by256.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./async_fifo_28by256.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot async_fifo_28by256 xil_defaultlib.async_fifo_28by256 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim async_fifo_28by256 -key {Behavioral:sim_1:Functional:async_fifo_28by256} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb async_fifo_28by256.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./async_fifo_28by256.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: async_fifo_28by256.sh [-help]\n\
Usage: async_fifo_28by256.sh [-step]\n\
Usage: async_fifo_28by256.sh [-lib_map_path]\n\
Usage: async_fifo_28by256.sh [-reset_run]\n\
Usage: async_fifo_28by256.sh [-reset_log]\n\
Usage: async_fifo_28by256.sh [-keep_index]\n\
Usage: async_fifo_28by256.sh [-noclean_files]\n\n\
