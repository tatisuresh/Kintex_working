...
#                script (type 'async_fifo_28by256.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.async_fifo_28by256 xil_defaultlib.glbl -o async_fifo_28by256_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./async_fifo_28by256_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key async_fifo_28by256_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc async_fifo_28by256_simv.daidir vcs_lib c.obj)
